 ...
 */
export const site = {
  name: 'Diamonds Tester',
  legalName: 'Diamonds Tester Gemological Services',
  tagline: 'Know if your diamond is real.',
  description:
    'Diamonds Tester is a precision diamond testing and verification service. Upload a photo or book a lab test and get a clear, expert-backed verdict on authenticity, carat, cut and clarity — in minutes, not weeks.',
  // Public-facing URL (used for canonical tags, sitemap, OG). Set in env for prod.
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://diamondstester.com',
  locale: 'en_US',
  ...
  contact: {
    ...
    whatsappMessage: "Hi Diamonds Tester — I'd like to verify a diamond.",
    email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hello@diamondstester.com',
